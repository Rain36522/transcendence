...
from .views import account_information, user_dashboard, user_login, user_register, social_management, user_login_api
...
urlpatterns = [
    ...
    path('api/login/', user_login_api.as_view(), name='login_api')
