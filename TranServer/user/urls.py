...
from .views import SignUpView, account_information, user_dashboard, user_login, user_register, social_management, user_login_api, api_signup, logout_view, user_profile_pic_api, upload_profile_pic_api, test_upload
...
urlpatterns = [
    ...
    path('api/profile_pic/<str:username>/', user_profile_pic_api, name='user_profile_pic_api'),
